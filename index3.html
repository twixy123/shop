...
<head>
    ...
    <title>Option3 - Kute shop - themelock.com</title>
</head>
    ...
    <div class="container main-header">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-3 logo">
                <a href="index.html"><img alt="Kute shop - themelock.com" src="assets/data/option3/logo3.png" /></a>
            </div>
                    ...
                    <div class="homeslider">
                        <div class="content-slide">
                            <ul id="slide-background">
                              <li data-background="#ffcc33"><img alt="Funky roots" src="assets/data/option3/slider1.jpg" title="Funky roots" /></li>
                              <li data-background="#666a69"><img alt="Funky roots" src="assets/data/option3/slider2.jpg" title="Funky roots" /></li>
                              <li data-background="#c1ddf6"><img  alt="Funky roots" src="assets/data/option3/slider3.jpg" title="Funky roots" /></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="trending-product owl-carousel nav-center" data-items="1" data-dots="false" data-nav="true" data-loop="true">
                                <ul>
                                    <li>
                                        <div class="product-container">
                                            <div class="product-image">
                                                <a href="#"><img src="assets/data/option3/p1.jpg" alt="Product"></a>
                                            </div>
                                    ...
                                    <li>
                                        <div class="product-container">
                                            <div class="product-image">
                                                <a href="#"><img src="assets/data/option3/p2.jpg" alt="Product"></a>
                                            </div>
                                            <div class="product-meta">
                                                <h5 class="product-name">
                                ...
                                <ul>
                                    <li>
                                        <div class="product-container">
                                            <div class="product-image">
                                                <a href="#"><img src="assets/data/option3/p41.jpg" alt="Product"></a>
                                            </div>
                                            <div class="product-meta">
                                                <h5 class="product-name">
                                                    <a href="#">Super Bag</a>
                                    ...
                                    <li>
                                        <div class="product-container">
                                            <div class="product-image">
                                                <a href="#"><img src="assets/data/option3/p42.jpg" alt="Product"></a>
                                            </div>
                                            <div class="product-meta">
                                                <h5 class="product-name">
                                                    <a href="#">Kute Yellow Bag</a>
                    ...
                    <div class="hot-deals-tab-content tab-container">
                            ...
                            <ul class="product-list owl-carousel nav-center" data-dots="false" data-loop="true" data-nav = "true" data-margin = "29" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                                <li>
                                    <div class="left-block">
                                        <a href="#"><img class="img-responsive" alt="product" src="assets/data/option3/p3.jpg" /></a>
                                ...
                                <li>
                                    <div class="left-block">
                                        <a href="#"><img class="img-responsive" alt="product" src="assets/data/option3/p4.jpg" /></a>
                                    </div>
                                    <div class="right-block">
                                ...
                                <li>
                                    <div class="left-block">
                                        <a href="#"><img class="img-responsive" alt="product" src="assets/data/option3/p5.jpg" /></a>
                                    </div>
                                    <div class="right-block">
                                ...
                                <li>
                                    <div class="left-block">
                                        <a href="#"><img class="img-responsive" alt="product" src="assets/data/option3/p6.jpg" /></a>
                                    </div>
                                    <div class="right-block">
                                ...
                                <li>
                                    <div class="left-block">
                                        <a href="#"><img class="img-responsive" alt="product" src="assets/data/option3/p7.jpg" /></a>
                                    </div>
                                    <div class="right-block">
                        ...
                        <div id="hot-deal-2" class="tab-panel">
                            <ul class="product-list owl-carousel nav-center" data-dots="false" data-loop="true" data-nav = "true" data-margin = "29" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                                <li>
                                    <div class="left-block">
                                        <a href="#"><img class="img-responsive" alt="product" src="assets/data/option3/p8.jpg" /></a>
        ...
        <div class="box-product-content">
            <div class="box-product-adv">
                <ul class="owl-carousel nav-center" data-items="1" data-dots="false" data-autoplay="true" data-loop="true" data-nav="true">
                    <li><a href="#"><img src="assets/data/option3/adv1.jpg" alt="adv"></a></li>
                    <li><a href="#"><img src="assets/data/option3/adv1.jpg" alt="adv"></a></li>
                </ul>
            </div>
